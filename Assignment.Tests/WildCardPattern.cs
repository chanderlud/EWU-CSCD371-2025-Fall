...
#pragma warning restore 56506
    ...
    public static string NormalizeLineEndings(string input, bool trimTrailingNewline = false)
    {
        ...
        if (trimTrailingNewline && input.EndsWith(Environment.NewLine, StringComparison.InvariantCulture))
        {
...
internal sealed class WildcardPatternToRegexParser : WildcardPatternParser
{
    ...
    {
        WildcardPatternToRegexParser parser = new();
...
internal sealed class WildcardPatternMatcher
{
    ...
    private sealed class MyWildcardPatternParser : WildcardPatternParser
    {
        ...
        {
            _bracketExpressionBuilder.Append(']');
            Regex regex = new(_bracketExpressionBuilder.ToString(), _regexOptions);
    ...
    private readonly struct CharacterNormalizer
    {
        ...
        public readonly char Normalize(char x)
        {
            if (_caseInsensitive)
            {
